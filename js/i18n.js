...
const TRANSLATIONS = {
  sv: {
    ...
    'trends.compliance':        'Efterlevnad',
    'trends.active_days':       'dagar med data',
    'trends.unique_stu':        'unika elever',
    'trends.students_affected': 'Elever berörda',
    'trends.of':                'av',
    'trends.daily_overview':    'Daglig översikt',
    'trends.breakdown':         'Fördelning',
    'trends.by_class':          'Per klass',
    'trends.by_weekday':        'Per veckodag',
    'trends.heatmap':           'Aktivitetskarta',
    ...
    'settings.flag_per_day':     'Nollställs varje dag (spara inte till nästa dag)',
    'settings.flag_per_day_short': 'Per dag',
    ...
    'settings.section_auditlog':      'Logg',
    'settings.auditlog_sub':          'Spåra statusändringar — vem ändrade vad och när.',
    'settings.auditlog_retain':       'Behåll logg i',
    'settings.auditlog_days':         'dagar',
    'settings.auditlog_purge_now':    'Rensa nu',
    'settings.auditlog_purge_confirm':'Rensa alla loggposter äldre än inställd period?',
    'settings.auditlog_purged':       'Logg rensad',
    'settings.auditlog_purge_error':  'Fel vid rensning',
    'settings.auditlog_search_ph':    'Sök elev eller e-post…',
    'settings.auditlog_clear':        'Rensa filter',
    'settings.auditlog_loading':      'Laddar logg…',
    'settings.auditlog_empty':        'Inga poster hittades.',
    'settings.auditlog_error':        'Fel vid hämtning',
    'settings.auditlog_entries':      'poster',
    'settings.auditlog_col_time':     'Tid',
    'settings.auditlog_col_student':  'Elev',
    'settings.auditlog_col_change':   'Ändring',
    'settings.auditlog_col_by':       'Av',
    ...
    'onboarding.step_sa':      'Signera tjänsteavtal',
    ...
    // DPA modal
    'sa.modal_title':        'Tjänsteavtal',
    'sa.summary_intro':      'Innan Lurkollen tas i bruk måste skolan godkänna tjänsteavtalet med Frånvarokollen Sverige AB.',
    'sa.key_points_title':   'Avtalets huvudpunkter',
    'sa.point_service':      'Frånvarokollen Sverige AB tillhandahåller Lurkollen som en molnbaserad tjänst.',
    'sa.point_access':       'Åtkomst ges via inbjudan — skolan ansvarar för att behöriga användare hanteras.',
    'sa.point_uptime':       'Vi strävar efter 99,5 % tillgänglighet under skoldagar (mån–fre 07–17).',
    'sa.point_billing':      'Fakturering sker per termin eller år enligt separat orderbekräftelse.',
    'sa.point_termination':  'Avtalet kan sägas upp av endera part med 30 dagars varsel.',
    'sa.point_data':         'Behandling av personuppgifter regleras i separat PUB-avtal (GDPR).',
    'sa.point_law':          'Avtalet regleras av svensk lag, Stockholms tingsrätt.',
    'sa.full_link':          'Läs hela avtalet (öppnas i ny flik) →',
    'sa.name_label':         'Ditt namn',
    'sa.name_placeholder':   'För- och efternamn',
    'sa.title_label':        'Befattning',
    'sa.title_placeholder':  'T.ex. Rektor, IT-ansvarig',
    'sa.checkbox_label':     'Jag har läst och accepterar detta avtal och bekräftar att jag är behörig att ingå avtal för skolans räkning.',
    'sa.sign_btn':           'Signera avtal',
    'sa.signed_ok':          '✓ Tjänsteavtal signerat',
    'sa.error_name':         'Ange ditt namn',
    'sa.error_checkbox':     'Du måste acceptera avtalet',
    ...
    'toast.imported_replaced':     '{n} elever importerade (tidigare lista ersatt)',
    'import.mode_title':           'Importera {n} elever',
    'import.mode_subtitle':        'Du har {ex} befintliga elever.',
    'import.mode_subtitle_empty':  'Inga befintliga elever.',
    'import.mode_replace_title':   'Ersätt alla elever',
    'import.mode_replace_desc':    'Ta bort alla {ex} befintliga elever och ersätt med de {n} nya.',
    'import.mode_replace_desc_empty': 'Importera {n} nya elever.',
    'import.mode_add_title':       'Lägg till / uppdatera',
    'import.mode_add_desc':        'Behåll befintliga elever. Nya läggs till, matchande uppdateras.',
    'import.mode_confirm':         'Importera →',
  ...
  en: {
    ...
    'trends.compliance':        'Compliance',
    'trends.active_days':       'days with data',
    'trends.unique_stu':        'unique students',
    'trends.students_affected': 'Students affected',
    'trends.of':                'of',
    'trends.daily_overview':    'Daily overview',
    'trends.breakdown':         'Breakdown',
    'trends.by_class':          'By class',
    'trends.by_weekday':        'By weekday',
    'trends.heatmap':           'Activity map',
    ...
    'settings.flag_per_day':     'Resets daily (does not carry to the next day)',
    'settings.flag_per_day_short': 'Per day',
    ...
    'settings.section_auditlog':      'Log',
    'settings.auditlog_sub':          'Track status changes — who changed what and when.',
    'settings.auditlog_retain':       'Keep log for',
    'settings.auditlog_days':         'days',
    'settings.auditlog_purge_now':    'Purge now',
    'settings.auditlog_purge_confirm':'Purge all log entries older than the retention period?',
    'settings.auditlog_purged':       'Log purged',
    'settings.auditlog_purge_error':  'Error purging log',
    'settings.auditlog_search_ph':    'Search student or email…',
    'settings.auditlog_clear':        'Clear filters',
    'settings.auditlog_loading':      'Loading log…',
    'settings.auditlog_empty':        'No entries found.',
    'settings.auditlog_error':        'Error loading log',
    'settings.auditlog_entries':      'entries',
    'settings.auditlog_col_time':     'Time',
    'settings.auditlog_col_student':  'Student',
    'settings.auditlog_col_change':   'Change',
    'settings.auditlog_col_by':       'By',
    ...
    'onboarding.step_sa':      'Sign service agreement',
    ...
    // DPA modal
    'sa.modal_title':        'Service Agreement',
    'sa.summary_intro':      'Before using Lurkollen, the school must accept the service agreement with Frånvarokollen Sverige AB.',
    'sa.key_points_title':   'Key terms',
    'sa.point_service':      'Frånvarokollen Sverige AB provides Lurkollen as a cloud-based service.',
    'sa.point_access':       'Access is granted by invitation — the school is responsible for managing authorised users.',
    'sa.point_uptime':       'We aim for 99.5% uptime during school days (Mon–Fri 07:00–17:00).',
    'sa.point_billing':      'Invoicing per term or year as per a separate order confirmation.',
    'sa.point_termination':  'Either party may terminate with 30 days notice.',
    'sa.point_data':         'Processing of personal data is governed by a separate DPA (GDPR).',
    'sa.point_law':          'This agreement is governed by Swedish law, Stockholm District Court.',
    'sa.full_link':          'Read the full agreement (opens in new tab) →',
    'sa.name_label':         'Your name',
    'sa.name_placeholder':   'First and last name',
    'sa.title_label':        'Job title',
    'sa.title_placeholder':  'e.g. Principal, IT Manager',
    'sa.checkbox_label':     'I have read and accept this agreement and confirm I am authorised to enter into agreements on behalf of the school.',
    'sa.sign_btn':           'Sign agreement',
    'sa.signed_ok':          '✓ Service agreement signed',
    'sa.error_name':         'Please enter your name',
    'sa.error_checkbox':     'You must accept the agreement',
    ...
    'toast.imported_replaced':     '{n} students imported (previous list replaced)',
    'import.mode_title':           'Import {n} students',
    'import.mode_subtitle':        'You have {ex} existing students.',
    'import.mode_subtitle_empty':  'No existing students.',
    'import.mode_replace_title':   'Replace all students',
    'import.mode_replace_desc':    'Remove all {ex} existing students and replace with the {n} new ones.',
    'import.mode_replace_desc_empty': 'Import {n} new students.',
    'import.mode_add_title':       'Add / update only',
    'import.mode_add_desc':        'Keep existing students. New ones are added, matching ones updated.',
    'import.mode_confirm':         'Import →',
